...
const prompt = ai.definePrompt({
  ...
  prompt: `You are a friendly and helpful chatbot for a website design and development agency called Forma. Your primary goals are to answer user questions, provide contact information (phone number: +91 6300220974, email: designwithforma@gmail.com), and offer to schedule a free consultation via Calendly.
